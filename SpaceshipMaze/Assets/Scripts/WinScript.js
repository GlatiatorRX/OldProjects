...
function OnGUI () {
	GUI.Box (Rect (Screen.width/2,100,0,0), "Congratulations! You have made it out alive!", notifyGUI);
	
	if(GUI.Button(Rect(Screen.width/2-50,Screen.height/4,100,50), "-Back to Menu-")){
		Application.LoadLevel(0);
	}
	if(GUI.Button(Rect(Screen.width/2-50,Screen.height/4*2,100,50), "-Credits-")){
